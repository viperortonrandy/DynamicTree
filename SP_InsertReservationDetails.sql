...
/****** Object:  StoredProcedure [hotels].[SP_InsertReservationDetails]    Script Date: 06/01/2016 18:24:28 ******/
...
BEGIN
    ...
    INSERT INTO [welcomgroup].[dbo].[ReservationDetails]
		   ...
		   ,[guest_country],[guest_state],[guest_city],[guest_pincode],[guest_company],[User_Type],[Chain_Code],[Hotel_Code],[Room_Type_Code],[Rate_Plan_Code],[hotel_Path],[is_cancelled],[AmountBreakup],[Plan_Type])
     VALUES
          (@guestId,@bookingStatus,@hotelName,@hotelAddress1,@hotelAddress2,@hotelContact,@hotelId,@roomId,
           ...
           @luxuryTax,@serviceTax,@vat,@totalTax,@prn,@bid,@pid,@txnDate,@hotelType,GETDATE(),@flightNumberArrival,@arrivalTime,@airportNameArrival,
			...
			@twHandle,@instaHandle,@guest_country,@guest_state,@guest_city,@guest_pincode,@guest_company,@userType,@chainCode,@hotelCode,@roomTypeCode,@ratePlanCode,@hotelPath,'N',@amountDetails,@planType)
